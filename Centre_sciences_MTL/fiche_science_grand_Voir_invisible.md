...
> Moi ( Alicia Castilloux) devant le Grand Studio , photo prise par Ammar Mrini, 1 avril 2026
...
La mise en espace de Voir l’invisible est pensée pour favoriser la découverte et la circulation des visiteurs plus facilement. L’installation s’intègre dans un espace ouvert et grand. Sur un croquis que j’ai réalisé durant ma visite, on peut observer la station et son espace, qui facilite l’accès aux différents dispositifs tout en maintenant une cohérence visuelle.

Le dispositif repose sur plusieurs composantes techniques, notamment des écrans interactifs avec des projections visuelles qui viennent avec des capteurs. Il y a trois écrans, l'un en infrarouge, l'un normal et l'un ultraviolet. De plus, une lumière bleu sur l'écran ultraviolet est utilisé pour augmenter la concrétisation de cette expérimentation. Ces éléments permettent de nous montrer des phénomènes invisibles que l'oeil nu ne peut pas voir. 
...
Si je devais proposer une amélioration, j’ajouterais davantage d’explications visuelles ou une autre forme d'activitée avec l'exposition, pour plus d'interaction avec les visiteurs.
